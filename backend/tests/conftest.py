...
def mock_ldap(mocker):
    ...
    mocker.patch('apps.users.ldap_service.generate_temp_username', return_value='g_abc12')
    ...
    mocker.patch('apps.keys.views.ldap.generate_temp_username', return_value='g_abc12')
